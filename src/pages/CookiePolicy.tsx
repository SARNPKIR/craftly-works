    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
          ...
          <h2>The specific types of first and third party cookies served through our Website and the purposes they perform are described below:</h2>
          ...
          <ul>
            <li><strong>Name:</strong> _ga</li>
            <li><strong>Purpose:</strong> Records a particular ID used to come up with data about website usage by the user.</li>
            <li><strong>Provider:</strong> Google</li>
            <li><strong>Service:</strong> Google Analytics</li>
            <li><strong>Expiry:</strong> 2 years</li>
            <li><strong>Type:</strong> HTTP Cookie</li>
          </ul>
          ...
          <ul>
            <li><strong>Name:</strong> _fbp</li>
            <li><strong>Purpose:</strong> Used by Facebook to deliver a series of advertisement products such as real time bidding from third party advertisers.</li>
            <li><strong>Provider:</strong> Facebook</li>
            <li><strong>Service:</strong> Facebook</li>
            <li><strong>Expiry:</strong> 3 months</li>
            <li><strong>Type:</strong> HTTP Cookie</li>
          </ul>
          ...
          <p>
            If you do not want Flash Cookies stored on your computer, you can adjust the settings of your Flash player to block Flash Cookies storage using the tools contained in the <a href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager07.html" target="_blank" rel="noopener noreferrer">Website Storage Settings Panel</a>. You can also control Flash Cookies by going to the <a href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager03.html" target="_blank" rel="noopener noreferrer">Global Storage Settings Panel</a> and following the instructions (which may include instructions that explain, for example, how to delete existing Flash Cookies (referred to "information" on the Macromedia site), how to prevent Flash LSOs from being placed on your computer without your being asked, and (for Flash Player 8 and later) how to block Flash Cookies that are not being delivered by the operator of the page you are on at the time).
          </p>
          <p>
